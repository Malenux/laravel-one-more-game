...
<section class="admin-table">
    ...
    <div class="table__header">
        <div class="table__header__box">
            <button class="filter-button" data-endpoint="{{ route('games') }}">
        ...
        @foreach($records as $record)
            <div class="table-row">
                ...
                <div class="element-box__upper-row">
                    <button class="edit-button" data-endpoint="{{ route('games_edit', $record->id) }}">
                    ...
                    <button class="delete-button" data-endpoint="{{ route('games_destroy', $record->id) }}">
                ...
                <div class="table-row__content">
                    <label>Title: {{ $record->title }}</label>
