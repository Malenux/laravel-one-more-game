...
<section class="admin-table">
            ...
            <div class="table-row">
                ...
                <div class="element-box__upper-row">
                    ...
                    <button class="delete-button" 
                        data-endpoint="{{ route('users_destroy', $record->id) }}">
    ...
    <div class="table__footer">
        ...
        <div class="table-page-controls">
            <button class="table-page-button first-page disabled" data-page="1">
            ...
            <button class="table-page-button prev-page disabled" data-page="1">
            ...
            <button class="table-page-button next-page disabled" data-page="1">
            ...
            <button class="table-page-button last-page disabled" data-page="1">
