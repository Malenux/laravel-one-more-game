...
<section class="admin-table">
    ...
    <div class="table__header">
        <div class="table__header__box">
            <button class="filter-button" data-endpoint="{{ route('users') }}">
        ...
        @foreach($records as $record)
            <div class="table-row">
                ...
                <div class="element-box__upper-row">
                    <button class="edit-button" data-endpoint="{{ route('users_edit', $record->id ?? $record->_id) }}">
                    ...
                    <button class="delete-button" data-endpoint="{{ route('users_destroy', $record->id ?? $record->_id) }}">
